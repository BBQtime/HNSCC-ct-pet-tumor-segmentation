...
if __name__ == "__main__":
    ...
    task_name = "Task230_hecktor_clip_sin"
    ...
    for p in patient_names:
        ...
        pts = os.path.join(downloaded_data_dir, p+"_ptsin.nii.gz")
        ...
        shutil.copy(pts, join(target_imagesTr, patient_name + "_0002.nii.gz"))
    ...
    if args.test == True:
        ...
        for p in test_patient_names:
            ...
            pts = os.path.join(downloaded_data_dir_test, p+"_ptsin.nii.gz")
            ...
            shutil.copy(pts, join(target_imagesTs, patient_name + "_0002.nii.gz"))
            #shutil.copy(gtv, join(target_labelsTs, patient_name + ".nii.gz"))

    json_dict = OrderedDict()
    json_dict['name'] = "Task230_hecktor_clip_sin"
