...
if __name__ == "__main__":
    ...
    task_name = "Task226_hecktor_sine"
    ...
    for p in patient_names:
        ...
        pt = os.path.join(downloaded_data_dir, p+"_ptsin.nii.gz")
    ...
    if args.test == True:
        ...
        for p in test_patient_names:
            ...
            pt = os.path.join(downloaded_data_dir_test,p+"_ptsin.nii.gz")
            #gtv = os.path.join(downloaded_data_dir,p+"_gtvt.nii.gz")
            print(ct)
            print(pt)
            assert all([
    ...
    json_dict['name'] = "Task226_hecktor_sine"
